...
public class PacienteController {
	...
	@PostMapping
	public ResponseEntity<Paciente> registar(@Valid @RequestBody Paciente p) throws Exception{
		Paciente obj = service.registar(p);
	...
	public ResponseEntity<Paciente> modificar(@Valid @RequestBody Paciente p) throws Exception{
		System.out.println("entrando al medtodo modificar");
